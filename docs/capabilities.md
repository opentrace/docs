...
OpenTrace answers questions about your system architecture — either through the built-in [Chat](chat.md) or via [MCP integrations](integrations/index.md) with your existing AI tools. Here's what you can ask.
